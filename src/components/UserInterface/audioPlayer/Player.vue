...
<script>
    import PlayerTitleBar from './сomponents/PlayerTitleBar.vue'
    import PlayerPlaylistPanel from './сomponents/PlayerPlaylistPanel.vue'
    import PlayerControlsBars from './сomponents/PlayerControlsBars.vue'
    import PlayerInfoPanel from './сomponents/PlayerInfoPanel.vue'
    import PlayerSearchBar from './сomponents/PlayerSearchBar.vue'
